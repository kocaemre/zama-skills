...
const EXPECTED_SKILLS = ['init', 'contract', 'test', 'deploy', 'frontend', 'design', 'audit', 'debug', 'doctor'] as const;
...
async function main() {
  ...
  // 4. All 9 SKILL.md files exist with correct invariants
  ...
  console.log('✓ marketplace + plugin + 9 SKILL.md frontmatters valid');
