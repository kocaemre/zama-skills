...
const EXPECTED_SKILLS = ['init', 'contract', 'test', 'deploy', 'frontend', 'design', 'audit', 'debug', 'doctor', 'autonomous'] as const;
...
async function main() {
  ...
  // 4. All 10 SKILL.md files exist with correct invariants
  ...
  console.log('✓ marketplace + plugin + 10 SKILL.md frontmatters valid');
