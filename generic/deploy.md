...
source: plugins/zama-skills/skills/deploy/SKILL.md
source_sha: 4aef2ffccb0fa76a2320d2227bb4ce73a9988a48
generator: scripts/generate-generic-docs.mjs
---

> Auto-generated from `plugins/zama-skills/skills/deploy/SKILL.md` by `scripts/generate-generic-docs.mjs`.
> Do not edit this file directly — edit the source SKILL.md and re-run `node scripts/generate-generic-docs.mjs`.
> Canonical SKILL.md SHA: `4aef2ffccb0fa76a2320d2227bb4ce73a9988a48` (CI gate: `npm run generic:check`).
...
Run `Bash(node <plugin-skill-dir>/scripts/lib/env-validate.ts)` (the script auto-loads `.env`). On failure the script exits non-zero and prints a **named-missing list**, e.g.:
...
`Bash(pnpm hardhat run --network sepolia scripts/deploy/<Name>.ts)` — or, equivalently, the orchestrator `Bash(node <plugin-skill-dir>/scripts/deploy.ts --contract <Name>)`.
...
`Bash(node <plugin-skill-dir>/scripts/lib/abi-export.ts <Name> <address>)` reads `artifacts/contracts/<Name>.sol/<Name>.json` and writes `packages/frontend/src/abis/<Name>.json`:
