...
source: plugins/zama-skills/skills/autonomous/SKILL.md
source_sha: 84ee56b8569d95b150201473d5f882d3d5dad1c0
generator: scripts/generate-generic-docs.mjs
---

> Auto-generated from `plugins/zama-skills/skills/autonomous/SKILL.md` by `scripts/generate-generic-docs.mjs`.
> Do not edit this file directly — edit the source SKILL.md and re-run `node scripts/generate-generic-docs.mjs`.
> Canonical SKILL.md SHA: `84ee56b8569d95b150201473d5f882d3d5dad1c0` (CI gate: `npm run generic:check`).
...
```bash
bash <plugin-skill-dir>/../doctor/scripts/diagnose.sh
```
